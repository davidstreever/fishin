...
function setDebugWeather(kind){ensureSeasonWeather();const aliases={Sunny:"Clear",Rainy:"Rain"};const requested=aliases[kind]||kind;const name=CONDITION_ORDER.includes(requested)?requested:"Cloudy";world.weather=makeWeatherState(name,world.weather?.temperatureF||60,world.weather?.windLevel||1,world.weather?.pattern||"stable");}
